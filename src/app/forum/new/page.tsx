    ...
    return (
        <div className="container mx-auto py-8 max-w-2xl">
            ...
            <form onSubmit={onSubmit} className="space-y-6 border p-6 rounded-lg bg-card">
                ...
                <p className="text-xs text-muted-foreground">Note: If you provide Year and Model, Make is required.</p>

                <div className="space-y-2">
                    <Label htmlFor="content">Content</Label>
                    <Textarea id="content" name="content" required placeholder="Share your thoughts..." rows={8} />
                </div>
