...
// Hardcoded for demo, normally fetched from DB/API
const MAKES = ["Toyota", "Honda", "Ford", "BMW", "Porsche", "Tesla"];
...
export function TagFilter() {
  ...
  return (
    <div className="p-4 space-y-4 border rounded-lg">
      ...
      <Button onClick={updateFilters} className="w-full">Apply Filters</Button>
      {(year || make || model) && (
          <Button variant="outline" onClick={() => router.push('/forum')} className="w-full mt-2">Clear</Button>
      )}
    </div>
  );
}
