...
const MAKES = ["Toyota", "Honda", "Ford", "BMW", "Mercedes", "Audi", "Porsche", "Lamborghini", "Ferrari", "Nissan", "Mazda", "Subaru", "Volkswagen", "Hyundai", "Kia", "Chevrolet", "Dodge", "Jeep", "Tesla", "Rivian"];
const YEARS = Array.from({ length: 30 }, (_, i) => (2025 - i).toString()); // 2025 down to 1996
const MODELS = {
    "Toyota": ["Camry", "Corolla", "RAV4", "Prius", "Supra", "Tacoma", "Tundra"],
